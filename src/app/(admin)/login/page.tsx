  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 font-sans">
      <form onSubmit={handleLogin} className="bg-white p-10 rounded-2xl shadow-xl w-[400px] border border-zinc-100">
        ...
        <p className="text-zinc-500 text-center text-sm mb-8">Infinity Vines Management</p>
        ...
        <div className="mb-5">
          ...
          <input className="w-full px-4 py-3 border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all" type="email" placeholder="admin@infinity.com" value={email} onChange={e => setEmail(e.target.value)} required />
        </div>
        <div className="mb-8">
